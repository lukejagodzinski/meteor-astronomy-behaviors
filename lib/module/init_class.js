...
methods.addBehavior = function(behaviorName, behaviorData) {
  ...
  // Check if the given behavior is already added to this or parent class.
  checks.added.call(this, behaviorName);

  // Get a copy of the behavior. We have to make a copy to be able pass custom
  // options. We don't want to modify original behavior.
